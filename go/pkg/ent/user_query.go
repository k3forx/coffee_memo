...
func (uq *UserQuery) QueryUserBrewRecipes() *UserBrewRecipeQuery {
	query := &UserBrewRecipeQuery{config: uq.config}
...
func (uq *UserQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (uq *UserQuery) FirstIDX(ctx context.Context) int32 {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) int32 {
...
func (uq *UserQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (uq *UserQuery) IDsX(ctx context.Context) []int32 {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withUserBrewRecipes: uq.withUserBrewRecipes.Clone(),
...
func (uq *UserQuery) WithUserBrewRecipes(opts ...func(*UserBrewRecipeQuery)) *UserQuery {
	query := &UserBrewRecipeQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserBrewRecipes = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withUserBrewRecipes; query != nil {
		...
		query.Where(predicate.UserBrewRecipe(func(s *sql.Selector) {
			s.Where(sql.InValues(user.UserBrewRecipesColumn, fks...))
		}))
