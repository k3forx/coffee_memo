...
func DeletedAt(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtEQ(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDeletedAt), v))
	})
}
...
func DeletedAtNEQ(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtIn(vs ...time.Time) predicate.DripRecipe {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtNotIn(vs ...time.Time) predicate.DripRecipe {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtGT(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtGTE(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtLT(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtLTE(v time.Time) predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtIsNil() predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
...
func DeletedAtNotNil() predicate.DripRecipe {
	return predicate.DripRecipe(func(s *sql.Selector) {
