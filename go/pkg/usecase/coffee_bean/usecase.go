...
type Usecase interface {
	GetAll(ctx context.Context, in GetAllInput) (*GetAllOutput, *result.Result)
...
func (u *CoffeeBeanUsecase) GetAll(ctx context.Context, in GetAllInput) (*GetAllOutput, *result.Result) {
